 ...
 *
 * ```jsx
 * import { composeStory } from '@storybook/angular';
 *
...
export function composeStory<TArgs extends Args = Args>(
  ...
  exportsName?: string
): ComposedStoryFn<AngularRenderer, Partial<TArgs>> {
  return originalComposeStory<AngularRenderer, TArgs>(
    story as StoryAnnotationsOrFn<AngularRenderer, Args>,
    // @ts-expect-error Angular's Meta wraps TArgs through TransformComponentType, producing an index signature that isn't assignable to generic TArgs
